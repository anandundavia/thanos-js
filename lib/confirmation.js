...
module.exports.showAndConfirmImplications = () =>
	new Promise((resolve, reject) => {
		logger.log(
			`\n\nDo you understand that when the Thanos snaps fingers, half of the files inside '${cwd}' directory will be deleted?\n`
		);
		logger.log('Do you still want Thanos to snap fingers?');
		logger.warn(
